...
// GET  /api/tiers?status=earned|paid|rejected|all   -> reward ledger + config
// POST /api/tiers { id, action: 'pay'|'reject' }     -> advance a reward
// PUT  /api/tiers { tier, min_orders?, bonus_amount? }-> edit config
